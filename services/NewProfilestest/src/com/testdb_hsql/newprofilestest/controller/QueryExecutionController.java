...
import com.testdb_hsql.newprofilestest.service.NewProfilestestQueryExecutorService;
...
@RestController(value = "NewProfilestest.QueryExecutionController")
@Api(value = "QueryExecutionController", description = "Controller class for query execution")
@RequestMapping("/NewProfilestest/queryExecutor")
public class QueryExecutionController {

    private static final Logger LOGGER = LoggerFactory.getLogger(QueryExecutionController.class);

    @Autowired
    private NewProfilestestQueryExecutorService queryService;
